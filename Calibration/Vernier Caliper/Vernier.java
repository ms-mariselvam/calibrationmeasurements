...
class Vernier {
    ...
    Double rss, acc, nss, ass, ucc, t1, t2, b, sd, ua;
    Double ub1, ub2, ub3, ub4, ub5, ub6, ub7, ub10, uc1, ue;
    int n;
    Double[] a;
    public void svt() {
        Scanner scanner = new Scanner(System.in);

        System.out.println("Resolution of vernier caliper:");
        rss = scanner.nextDouble();

        System.out.println("Accuracy of the vernier caliper:");
        acc = scanner.nextDouble();

        System.out.println("Nominal size of slip gauge:");
        nss = scanner.nextDouble();

        System.out.println("Actual length of vernier caliper:");
...
class Main {
    public static void main(String[] args) {
        Vernier calibration = new Vernier();
        calibration.svt();
        calibration.gvt();
        //Type A Uncertainty
        calibration.typeA();
...
/*This code calculates various types of uncertainties related to the measurement using a Vernier caliper.
All uncertainties are expressed in micrometers. It first reads the relevant inputs, such as the resolution of
the Vernier caliper, accuracy, and other measurement parameters. It calculates Type A uncertainty based on the
standard deviation of measured values and converts this into micrometers. For Type B uncertainties, it evaluates
contributions from size differences, calibration, resolution, temperature effects, and the accuracy of the Vernier
caliper, all in micrometers. The combined uncertainty is determined by summing the squares of all individual
